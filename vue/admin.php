				...
				<div class="col-md-8 shadow-sm p-3 mb-5 bg-body rounded">
					<div class=" col-md-12 container shadow-sm p-3 mb-5 bg-body rounded">
					    <ul class="nav nav-tabs justify-content-center">
					      <li class="nav-item ">
					        <a class="nav-link active" aria-current="page" href="ajouter.php">Ajouter un Etudiant</a>
					      </li>
					      <li class="nav-item">
  					...
  					<div class="row">
  						...
  						<div class="col-md-8">
  							...
  							<span style="margin-top:20px;" class="text-center">indiciplinés</span>
  							<div class="progress">

  								<div class=" progress-bar-animated progress-bar-striped progress-bar bg-danger" role="progressbar" style="width: 5%;" aria-valuenow="5" aria-valuemin="0" aria-valuemax="100">
  									
  								</div>
  							</div>
  							<span style="margin-top:20px;" class="text-center">Redressement</span>
  							<div class="progress">

  								<div class="progress-bar-animated progress-bar-striped progress-bar bg-primary" role="progressbar" style="width: 20%;" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
  									
  								</div>
  							</div>
  							<span style="margin-top:20px;" class="text-center">Pas mal</span>
  							<div class="progress">

  								<div class="progress-bar-animated progress-bar-striped progress-bar bg-warning" role="progressbar" style="width: 30%;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">
  									
  								</div>
  							</div>
  							<span style="margin-top:20px;" class="text-center">Nice</span>
  							<div class="progress ">

  								<div class="progress-bar-animated progress-bar-striped progress-bar bg-success" role="progressbar" style="width: 80%;" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100">
